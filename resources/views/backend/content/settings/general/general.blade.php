                ...
                <div class="row">
                    <div class="col-5 col-sm-4">
                        <div class="nav flex-column nav-tabs h-100" id="vert-tabs-tab" role="tablist"
                            ...
                            <!-- <a class="nav-link" id="vert-tabs-banner-tab" data-toggle="pill"
                                    href="#vert-tabs-banner" role="tab" aria-controls="vert-tabs-banner"
                                    aria-selected="false">Banner Settings</a> -->
                    ...
                    <div class="col-7 col-sm-8">
                        <div class="tab-content" id="vert-tabs-tabContent">
                            ...
                            <div class="tab-pane fade" id="vert-tabs-banner" role="tabpanel"
                                aria-labelledby="vert-tabs-banner-tab">
