...
<div class="row">
            ...
            <div class="card shadow-sm border-0 mb-4" style="border-radius: 12px;">
                <div class="card-header bg-white py-3 border-0">
                    <h5 class="mb-0 font-weight-bold" style="color: #1e293b;">
                        <i class="fas fa-info-circle text-primary mr-2"></i>General About Page Information
                    </h5>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group mb-3">
                                ...
                                @if($about && $about->banner_img)
                                    <div class="mb-2">
                                        <img src="{{ asset('/setting/about/' . $about->banner_img) }}" alt="Current Banner" style="max-height: 100px; border-radius: 8px; border: 1px solid #e2e8f0;">
                                    </div>
                                @endif
                        ...
                        <div class="col-lg-6">
                            <div class="form-group mb-3">
                                ...
                                @if($about && $about->about_image)
                                    <div class="mb-2">
                                        <img src="{{ asset('/setting/about/' . $about->about_image) }}" alt="Current About Image" style="max-height: 100px; border-radius: 8px; border: 1px solid #e2e8f0;">
                                    </div>
                                @endif
                        ...
                        <div class="col-lg-12">
                            <div class="form-group mb-3">
                                ...
                                <textarea class="form-control" rows="3" name="short_description" placeholder="Enter short summary description...">{{ $about->short_description ?? '' }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12">
                            <div class="form-group mb-3">
                                ...
                                <textarea class="editor form-control" rows="6" name="description">{!! $about->description ?? '' !!}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card shadow-sm border-0 mb-4" style="border-radius: 12px;">
                ...
                <div class="card-body">
                    <div class="row">
                        {{-- Strength 1 --}}
                        @php
                            $s1Img = $about && $about->strength_one_icon ? (file_exists(public_path('setting/about/' . $about->strength_one_icon)) ? asset('setting/about/' . $about->strength_one_icon) : asset('setting/brand/' . $about->strength_one_icon)) : asset('setting/brand/hybrid.png');
                        @endphp
                        ...
                        {{-- Strength 2 --}}
                        @php
                            $s2Img = $about && $about->strength_two_icon ? (file_exists(public_path('setting/about/' . $about->strength_two_icon)) ? asset('setting/about/' . $about->strength_two_icon) : asset('setting/brand/' . $about->strength_two_icon)) : asset('setting/brand/best_price.jpg');
                        @endphp
                        <div class="col-lg-6 col-md-6 mb-4">
                            <div class="p-3 border rounded" style="background: #f8fafc; border-radius: 10px;">
                                <div class="d-flex align-items-center mb-3">
                        ...
                        {{-- Strength 3 --}}
                        @php
                            $s3Img = $about && $about->strength_three_icon ? (file_exists(public_path('setting/about/' . $about->strength_three_icon)) ? asset('setting/about/' . $about->strength_three_icon) : asset('setting/brand/' . $about->strength_three_icon)) : asset('setting/brand/quality.png');
                        @endphp
                        <div class="col-lg-6 col-md-6 mb-4">
                            <div class="p-3 border rounded" style="background: #f8fafc; border-radius: 10px;">
                                <div class="d-flex align-items-center mb-3">
                        ...
                        {{-- Strength 4 --}}
                        @php
                            $s4Img = $about && $about->strength_four_icon ? (file_exists(public_path('setting/about/' . $about->strength_four_icon)) ? asset('setting/about/' . $about->strength_four_icon) : asset('setting/brand/' . $about->strength_four_icon)) : asset('setting/brand/eco.jpg');
                        @endphp
                        <div class="col-lg-6 col-md-6 mb-4">
                            <div class="p-3 border rounded" style="background: #f8fafc; border-radius: 10px;">
                                <div class="d-flex align-items-center mb-3">
    ...
    <div class="col-lg-12">
        <div class="card shadow-sm border-0" style="border-radius: 12px;">
            <div class="card-header bg-white py-3 border-0">
                <h5 class="mb-0 font-weight-bold" style="color: #1e293b;">
                    <i class="fas fa-list text-primary mr-2"></i>Current About Page Record
                </h5>
            </div>
                ...
                <div class="table-responsive">
                    <table class="table table-hover align-middle mb-0" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    @if($about->about_image)
                                        <img src="{{ asset('/setting/about/' . $about->about_image) }}" style="height: 60px; width: 60px; object-fit: cover; border-radius: 8px;">
                                    @else
                                        <span class="text-muted">N/A</span>
                                    @endif
                                </td>
                                <td class="font-weight-bold text-dark">{{ $about->title ?? 'N/A' }}</td>
                                <td class="text-muted" style="max-width: 300px;">{{ \Illuminate\Support\Str::limit($about->short_description ?? 'N/A', 120) }}</td>
                                <td>
                                    <div class="d-flex" style="gap: 6px;">
                                        <span class="badge badge-light border" title="{{ $about->strength_one_title ?? 'Strength 1' }}">1. {{ $about->strength_one_title ?? 'Reliable' }}</span>
                                        <span class="badge badge-light border" title="{{ $about->strength_two_title ?? 'Strength 2' }}">2. {{ $about->strength_two_title ?? 'Affordable Price' }}</span>
                                        <span class="badge badge-light border" title="{{ $about->strength_three_title ?? 'Strength 3' }}">3. {{ $about->strength_three_title ?? 'High Quality' }}</span>
                                        <span class="badge badge-light border" title="{{ $about->strength_four_title ?? 'Strength 4' }}">4. {{ $about->strength_four_title ?? 'Green Energy' }}</span>
                                    </div>
                                </td>
                                <td class="text-right">
                                    <a href="{{ route('admin.about.settings.edit', ['id' => $about->id]) }}" class="btn btn-sm btn-outline-primary" style="border-radius: 6px;">
                            ...
                            @else
                            <tr>
                                <td colspan="5" class="text-center py-4 text-muted">No About records found. Create one above.</td>
                            </tr>
                            @endif
                        </tbody>
                    </table>
